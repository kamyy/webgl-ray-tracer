...
export default class Matrix4x4 {
  ...
  inverse(): Matrix4x4 {
    return new Matrix4x4([
      ...
      -(this._m[_30] * this._m[_20] + this._m[_31] * this._m[_21] + this._m[_32] * this._m[_22]),
      1,
    ]);
  }
  ...
  toString(): string {
    return `[Matrix4x4 ${this._m[_00]}, ${this._m[_01]}, ${this._m[_02]}, ${this._m[_03]}, ${this._m[_10]}, ${this._m[_11]}, ${this._m[_12]}, ${this._m[_13]}, ${this._m[_20]}, ${this._m[_21]}, ${this._m[_22]}, ${this._m[_23]}, ${this._m[_30]}, ${this._m[_31]}, ${this._m[_32]}, ${this._m[_33]}]`;
  }
}
